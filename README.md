...
This is just a collection of examples which show the application of Linear Programming ([Wikipedia](https://en.wikipedia.org/wiki/Linear_programming)).
I added a Dockerfile for testing this inside a docker container.
